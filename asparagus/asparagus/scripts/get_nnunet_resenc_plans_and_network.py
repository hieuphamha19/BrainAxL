...
class ResEncUNetPlanner(ExperimentPlanner):
    ...
    def get_plans_for_configuration(
        ...
        while estimate > reference:
            ...
            # print(pool_op_kernel_sizes, estimate, reference)
            (
                network_num_pool_per_axis,
                pool_op_kernel_sizes,
                conv_kernel_sizes,
...
if __name__ == "__main__":
    """
    export nnUNet_preprocessed="/Users/zcr545/Desktop/Projects/repos/nnunet_data/preprocessed"
    export nnUNet_raw="/Users/zcr545/Desktop/Projects/repos/nnunet_data/raw"
    export nnUNet_results="/Users/zcr545/Desktop/Projects/repos/nnunet_data/results"

    """
    from nnunetv2.utilities.get_network_from_plans import get_network_from_plans
    from torchinfo import summary

    planner = nnUNetPlannerResEncM(dataset_name_or_id="300")
    plans = planner.get_plans_for_configuration(
        spacing=(
            1.0,
            1.0,
            1.0,
        ),
        median_shape=(256, 256, 256),
        data_identifier="300",
        approximate_n_voxels_dataset=99999999999999999999,
        _cache={},
    )
    print("MMMMMMMM \n", plans)
    net = get_network_from_plans(
        ...
        arch_kwargs_req_import=plans["architecture"]["_kw_requires_import"],
        input_channels=1,
        output_channels=2,
    )
    summary(net, input_size=(1, 1, 64, 64, 64))
    # plans = nnUNetPlannerResEncM(dataset_name_or_id="300")
    # print(
    #    "MMMMMMMM \n",
    #    plans.get_plans_for_configuration(
    #        spacing=(
    #            1.0,
    #            1.0,
    #            1.0,
    ...
    #    ),
    # )
    # plans = nnUNetPlannerResEncL(dataset_name_or_id="300")
    # print(
    #    "LLLLLLLL \n",
    #    plans.get_plans_for_configuration(
    #        spacing=(
    ...
    #    ),
    # )
    # plans = nnUNetPlannerResEncXL(dataset_name_or_id="300")
    # print(
    #    "XXXXXXX \n",
    #    plans.get_plans_for_configuration(
    #        spacing=(
    ...
    #        median_shape=(128, 128, 128),
    #        data_identifier="300",
    #        approximate_n_voxels_dataset=999999999909999999999,
    #        _cache={},
    #    ),
    # )
    # print(
    ...
    # )
    """
    OUTPUT for any decently standard setup:
